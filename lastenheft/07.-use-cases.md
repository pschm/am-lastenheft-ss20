...
| Autoren  | Team 4 |
| Kritikalität | hoch  |
| Beschreibung  | Die aufgetretenen Störungen an den Maschinen werden ausgewertet. Es wird eine Fehleranalyse durchgeführt. Die Ursache einer Störung wird somit ermittelt.  |
...
| Hauptszenario  | 1. Die aufgetretenen Störungen an Geräten werden erfasst und automatisch in das System eingetragen. <br/> 2. Der Nutzer startet die Analyse. <br/>3. Die Ursache der Störung wird analysiert. Dabei werden Störungsdaten für die Fehleranalyse aufgerufen. <br/> 4. Die Anzahl einer Störung aus demselben Grund wird ermittelt. <br/> 5. Das System zeigt die Auswertung an. |
...
| Ausnahmeszenarien  | 1a. Die Störungsdaten werden nicht in das System eingetragen. <br/> 2b. Analyse kann nicht stattfinden, da kein Tool dafür vorhanden ist. <br/>3a1. Es sind keine Störungsdaten vorhanden. <br/>3a2. Die Auswertungen sind fehlerhaft.
   |
### 7.2.4 Team 5
