...
- Auswirkungen auf die Stakeholder: Durch die Filterung von Daten kann die Qualität beeinflusst werden.
- Einschränkungen: 
   - Datenkonsistenz
...
- Stakeholder: Unternehmen, Alle Nutzer
- Auswirkungen auf die Stakeholder: Erkenntnisgewinn aus über mehrere Standorte aggregierte Daten (z.B. für Fehleranalyse) 
- Einschränkungen:
