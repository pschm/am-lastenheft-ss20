...
<table style="width:100%">
  ...
  <tr>
    ...
    <td>Unternehmen, Alle Nutzer </td>
    <td>Alle können von den gesammelten Erkenntnissen profitieren. Ein gemeinsamer Datenpool für Informationen.</td>
    <td>Lizenzen, Enterprise-Segment Kunden möchten wahrscheinlich keine Open Source Systeme.</td>
  <td>QU-0105</td>
  </tr>
</table>
